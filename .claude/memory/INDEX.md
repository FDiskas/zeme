...
- [ux-goal-elderly-readability](project/ux-goal-elderly-readability.md) — full redesign: modern + comfortable for elderly; theme = land & buildings; clean readable map+report. keywords: ux, ui, redesign, modern, theme, land, buildings, readability, elderly, accessibility, design-goal
